...
##testcase 4158 1249087 open pdf
sub is_applicable
{
...
sub run()
{
    ...
    #mkdir a directory /tmp/test to save the testing file pdf.pdf
    my $self=shift;
    x11_start_program("gnome-terminal");
    script_run("/usr/bin/mkdir -p  /tmp/test",3);
    script_run("cd /tmp/test",3);
    script_run("wget http://upload.kruton.de/files/1381902942/pdf.pdf",3);
